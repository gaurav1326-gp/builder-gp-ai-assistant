export default function GeometricOverlay() {
  return (
    <div className="absolute inset-0 overflow-hidden opacity-20 dark:opacity-10 pointer-events-none">
      ...
      <div className="absolute top-1/6 left-1/4 w-8 h-8 border border-blue-300/50 rotate-45 animate-spin" style={{ animationDuration: '15s' }} />
      ...
      <div className="absolute top-2/3 right-1/3 w-4 h-4 bg-pink-300/50 rotate-45 animate-spin" style={{ animationDuration: '12s', animationDirection: 'reverse' }} />
