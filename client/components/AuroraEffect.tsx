      ...
      <div className="absolute inset-0">
        ...
        <div 
          ...
          style={{ 
            ...
            transform: 'translateX(-50%) translateY(-20%) skewY(-12deg) rotate(15deg)'
          }}
        />
        ...
        <div 
          ...
          style={{ 
            ...
            animationDelay: '2s',
            transform: 'translateX(-30%) translateY(10%) skewY(-6deg) rotate(-10deg)'
          }}
        />
        ...
        <div 
          ...
          style={{ 
            ...
            animationDelay: '4s',
            transform: 'translateX(20%) translateY(-30%) skewY(8deg) rotate(25deg)'
          }}
        />
        ...
        <div 
          ...
          style={{ 
            ...
            animationDelay: '1s',
            transform: 'translateX(10%) translateY(40%) skewY(-4deg) rotate(-20deg)'
          }}
        />
        ...
        <div 
          ...
          style={{ 
            ...
            animationDelay: '3s',
            transform: 'translateX(-20%) translateY(20%) skewY(10deg) rotate(30deg)'
          }}
        />
      </div>
